...
function Update() {
    const [credentials1, setCredentials1] = useState({firstName:"", lastName: "", email:"", mobile:"", position:"",age:"", address:"", city:"", state:"",zipcode:"",id:""});
    let navigate1 = useNavigate();
    const handleSignup = async (e)=>{
        e.preventDefault();
        
        const {firstName, lastName, email,mobile,position,age,address,city,state,zipcode,id} = credentials1;
        const response = await fetch("http://localhost:5000/updateData", {
            ...
            body: JSON.stringify({firstName, lastName, email,mobile,position,age,address,city,state,zipcode,id})
    ...
    <>
        ...
        <div className='form'>
            ...
            <form onSubmit={handleSignup}>
                <div id="empId">
                    <label for="inputName4">Enter Unique Employee Id</label>
                    <input type="text" name="id" class="form-control"  placeholder="Employee Id" onChange={onChange1}/>
                    <button onClick={Find} class="btn btn-primary" >Fetch</button>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    <label for="inputName4">First Name</label>
                    <input type="text" name="firstName" class="form-control"  placeholder="First Name" value={users.FIRSTNAME} onChange={onChange1}/>
                    </div>
                    <div class="form-group col-md-6">
